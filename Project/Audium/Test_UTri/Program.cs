...
namespace Test_UTri
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            EnsembleAudio e3 = new EnsembleAudio("ROM", "Read Only Memory", "img.png", EGenre.GenreMusique.JAZZ);
            ...
            Dictionary<EnsembleAudio, LinkedList<Piste>> rech = URecherche.RechercherParGenre(EGenre.GenreMusique.JAZZ);
